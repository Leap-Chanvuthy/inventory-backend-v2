 ...
 *   @OA\Property(property="customer_address", type="string", nullable=true, example="Phnom Penh"),
...
interface CustomerAPIControllerInterface
{
     ...
     *             @OA\Schema(
     *                 required={"fullname","phone_number","customer_status","customer_category_id"},
     ...
     *                 @OA\Property(property="customer_address", type="string", nullable=true, maxLength=255, example="Phnom Penh"),
     ...
     *                 @OA\Property(property="customer_address", type="string", nullable=true, maxLength=255, example="Updated address"),
     *                 @OA\Property(property="google_map_link", type="string", nullable=true, maxLength=100, example="https://maps.google.com/..."),
